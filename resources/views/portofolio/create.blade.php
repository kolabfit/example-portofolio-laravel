    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form action="{{ route('portofolio.store') }}" method="post" class="mx-8 my-6">
                    @csrf
                    <div class="mb-6 w-1/2">
                        ...
                        <input type="text" id="judul_porto" name="judul_porto"
                            ...
                            placeholder="Portofolio X" required>
                    </div>
                    ...
                    <div class="mb-6 w-3/4">
                        ...
                        <textarea id="deskripsi" name="deskripsi" rows="4"
                            ...
                            placeholder="Portofolio tentang..."></textarea>
                    </div>
                    <div class="mb-6 w-3/4">
                        ...
                        <input type="text" id="url" name="url"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            placeholder="https://example.com/xxx" required>
                    </div>
